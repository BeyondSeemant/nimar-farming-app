          ...
          <div className="main-card">
            ...
            <div className="portal-header">
              <div className="portal-brand">
                <div className="portal-emblem">🏛</div>
                <div>
                  <div className="portal-name">Agri Support Portal</div>
                  <div className="portal-sub">Government of India Initiative</div>
                </div>
              </div>
              ...
              <div className="hero-left">
                <div style={{ marginTop: 8 }}>
                  ...
                  <p className="hero-subtitle">
                    Find the right government schemes tailored <span>for you</span>
                  </p>
                </div>
